...
public class ExceptionsTest {
    ...
    void should_wrap_exception_for_functions_with_result() throws IOException {
        ...
        assertThatThrownBy(() -> Exceptions.evaluate(exceptions::evaluate)).isInstanceOf(RuntimeException.class).isSameAs(runtimeException);
    }
    ...
    void should_wrap_unchecked_exception_for_functions_with_result() throws IOException {
        ...
        assertThatThrownBy(() -> Exceptions.evaluate(exceptions::evaluate)).isInstanceOf(RuntimeException.class);
    }
